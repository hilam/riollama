...
class ChatPage(rio.Component):
    """
    This is the only page in the entire chat. It displays the chat history, a
    ...
    # If this is `True`, the chat is currently generating a response. An
    # indicator will be displayed to the user, and the text input will be
    # disabled.
    is_loading: bool = False

    model_name: str = 'granite-code:3b-instruct-q4_K_M'
    ...
    async def on_question(self, message_text: str) -> None:
        ...
        # Indicate to the user that the chat is doing something
        ...
        try:
            await self.conversation.respond(
                client=self.session[ollama.AsyncClient],
            ...
            rio.Column(
                ...
                rio.Row(
                    rio.MultiLineTextInput(
                        label="Digite a pergunta ou instrução...",
